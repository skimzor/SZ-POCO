...
You are able to use the OEM DC/DC Regulator Board with the SZ Pocket Color; however, there are more modern options suggested below:

- [marshalllh's GBPP](https://github.com/marshallh/gbpp)
